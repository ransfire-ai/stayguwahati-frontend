          ...
          <div className="p-6 sm:p-10">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              ...
              {booking.roomTypeName && (
                <div className="rounded-2xl bg-[#eef7f4] p-4 sm:col-span-2">
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    {booking.roomTypePrice ? `₹${Number(booking.roomTypePrice).toLocaleString('en-IN')} / night` : ''}
                    {booking.roomTypeUnits ? ` · ${booking.roomTypeUnits} unit` : ''}
                  </p>
                </div>
              )}
            </div>
