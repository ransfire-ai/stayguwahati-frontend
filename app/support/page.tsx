...
export default function TrustSupportPage() {
  ...
  return (
    <div className="bg-slate-50 text-slate-800 font-sans antialiased min-h-screen w-full overflow-x-hidden">
      {/* Sticky Navigation */}
      <nav className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-slate-100 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex justify-between items-center">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <Building2 className="w-6 h-6 sm:w-7 sm:h-7 text-teal-600" />
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
            ...
            <select
              ...
              className="bg-slate-50 border border-slate-200 text-xs rounded-lg p-1.5 focus:outline-none focus:border-teal-500 font-semibold text-slate-700 cursor-pointer transition"
            >
          ...
          <div className="flex md:hidden items-center gap-3">
            ...
            <button
              ...
              className="p-2 text-slate-600 hover:text-teal-600 focus:outline-none"
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          <span className="bg-teal-50 text-teal-700 text-xs font-bold px-3 py-1 rounded-full border border-teal-100 inline-block">
            {t.hub_badge}
          </span>
          <h1 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight mt-3 mb-3 leading-tight">
            {t.hub_heading}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-start">
          ...
          <div className="md:col-span-2 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="border-b border-slate-100 pb-3 sm:pb-4">
                  <button
                    ...
                    className="w-full flex justify-between items-center text-left font-bold text-slate-800 hover:text-teal-600 transition py-2 gap-2"
                  >
            ...
            {/* Features Cards Grid */}
            <div className="bg-white border border-slate-100 rounded-2xl p-4 sm:p-6 shadow-xs grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-100/50 flex gap-3 items-start">
                <ShieldCheck className="w-6 h-6 text-teal-600 mt-0.5 shrink-0" />
                <div>
                  <h4 className="font-bold text-sm text-slate-900">{t.feat_secure_title}</h4>
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-100/50 flex gap-3 items-start">
                <UserCheck className="w-6 h-6 text-teal-600 mt-0.5 shrink-0" />
                <div>
                  <h4 className="font-bold text-sm text-slate-900">{t.feat_reviews_title}</h4>
                  <p className="text-xs text-slate-500 mt-1 leading-normal">
                    {t.feat_reviews_desc}
                  </p>
                </div>
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-5 sm:p-6 shadow-xl shadow-slate-100/50 w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 focus:border-teal-500 focus:bg-white rounded-xl px-3.5 py-2.5 text-sm font-medium transition outline-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-200 focus:border-teal-500 focus:bg-white rounded-xl px-3.5 py-2.5 text-sm font-medium transition outline-none resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={submitting}
                className={`w-full bg-slate-900 hover:bg-teal-600 text-white font-bold py-3 px-4 rounded-xl transition duration-200 shadow-md flex justify-center items-center gap-2 text-sm ${
